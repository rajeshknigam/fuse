...
public class BlueprintXmlTest1 extends CamelBlueprintTestSupport {
	...
	@Produce(uri = "jetty:http://0.0.0.0:7080/jettysample?exchangePattern=InOut&synchronous=true")
